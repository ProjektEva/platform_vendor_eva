...
# Versioning System
# eva first version.
PRODUCT_VERSION_MAJOR = androidX
...
# Set all versions
EVA_VERSION := eva-$(EVA_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(EVA_POSTFIX)
EVA_MOD_VERSION := eva-$(EVA_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(EVA_POSTFIX)
