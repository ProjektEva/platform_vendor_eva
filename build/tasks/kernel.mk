...
ifeq ($(TARGET_KERNEL_CLANG_COMPILE),true)
    ...
    KBUILD_COMPILER_STRING := $(shell $(TARGET_KERNEL_CLANG_PATH)/clang --version | head -n 1 | $(BUILD_TOP)/prebuilts/tools-eva/$(HOST_OS)-x86/bin/perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g')
