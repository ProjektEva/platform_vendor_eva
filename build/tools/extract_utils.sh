...
function oat2dex() {
    ...
    if [ -z "$BAKSMALIJAR" ] || [ -z "$SMALIJAR" ]; then
        export BAKSMALIJAR="$EVA_ROOT"/vendor/eva/build/tools/smali/baksmali.jar
        export SMALIJAR="$EVA_ROOT"/vendor/eva/build/tools/smali/smali.jar
    fi
